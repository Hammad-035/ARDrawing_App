...
class OnboardingLesson extends Component {
  constructor(props) {
    super(props);
...
OnboardingLesson.propTypes = {
  ...
  OnboardingDot: PropTypes.oneOfType([PropTypes.element, PropTypes.func]),
